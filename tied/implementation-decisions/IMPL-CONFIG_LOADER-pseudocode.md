...
CONTRACT Summary
  INPUT: relative path under project root (e.g. config/site.yaml)
...
PROCEDURE IMPL-CONFIG_LOADER_DeepMerge(target, source)
...
PROCEDURE IMPL-CONFIG_LOADER_GetSiteConfig()
...
CONTRACT GetThemeConfig
  INPUT: none
  OUTPUT: ThemeConfig
  DATA: _themeConfig cache

PROCEDURE IMPL-CONFIG_LOADER_GetThemeConfig()
...
PROCEDURE IMPL-CONFIG_LOADER_GetFilesConfig()
...
CONTRACT ResetConfigCache
  INPUT: test harness
  OUTPUT: caches null
  CONTROL: @internal export _resetConfigCache

PROCEDURE IMPL-CONFIG_LOADER_ResetConfigCache()
  _siteConfig := null
  _themeConfig := null
  _filesConfig := null

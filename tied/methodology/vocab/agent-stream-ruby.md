...
**Traceability:** REQ-ATDD-COMPOS-AGENT_STREAM_TDD_YAML · REQ-ATDD-COMPOS-EXPORT_TDD_PROMPTS_STEPS · REQ-ATDD-E2E-AGENT_STREAM · ARCH-ATDD-COMPOS-DELEGATE_TO_TDD_LOOP_PROMPTS · ARCH-ATDD-E2E_SUBPROCESS_STREAM_JSON

**See also:** [`domain-references.md`](domain-references.md) · [`agentstream.md`](agentstream.md) · `../../tools/agent-stream/` · `../../scripts/run-feature-batch.sh`
...
|----------------|-------------------|-------------|
| Wire TDD YAML turns from argv | `wire_tdd_yaml_turns_from_argv` | IMPL-ATDD-COMPOS-AGENT_STREAM_ARGV |
| Export step entries to markdown | `export_step_entries_to_markdown` | IMPL-ATDD-COMPOS-EXPORT_TDD_PROMPTS |
| Run agent subprocess | `run_agent_stream_subprocess` | IMPL-ATDD-E2E-AGENT_STREAM |
